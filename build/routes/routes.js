...
router.post('/menu', _auth.default.confirmToken, _auth.default.confirmCaterer, _menu.default.addMeal);
router.put('/menu', _auth.default.confirmToken, _auth.default.confirmCaterer, _menu.default.editMeal);
